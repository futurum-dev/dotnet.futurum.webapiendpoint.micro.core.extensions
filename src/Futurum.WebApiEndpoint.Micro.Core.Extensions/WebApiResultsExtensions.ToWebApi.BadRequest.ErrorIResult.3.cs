...
public static partial class WebApiResultsExtensions
{
    public static Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>> ToWebApi<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3>(
        ...
        result.Switch(() => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)resultHandler(context),
                      error => resultErrorHandler1(error, context).Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x)
                                                                  .OrElse(() => resultErrorHandler2(error, context)
                                                                              .Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x))
                                                                  .OrElse(() => resultErrorHandler3(error, context)
                                                                              .Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x))
                                                                  .GetValueOrDefault(() => error.ToWebApiBadRequest(context)));

    public static Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>> ToWebApi<T, TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3>(
        ...
        where TErrorIResult2 : IResult
        where TErrorIResult3 : IResult =>
        result.Switch(value => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)resultHandler(context, value),
                      error => resultErrorHandler1(error, context).Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x)
                                                                  .OrElse(() => resultErrorHandler2(error, context)
                                                                              .Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x))
                                                                  .OrElse(() => resultErrorHandler3(error, context)
    ...
    public static Task<Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>> ToWebApiAsync<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3>(
        ...
        where TErrorIResult2 : IResult
        where TErrorIResult3 : IResult =>
        result.SwitchAsync(() => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)resultHandler(context),
    ...
    public static Task<Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>> ToWebApiAsync<T, TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3>(
        ...
        where TErrorIResult2 : IResult
        where TErrorIResult3 : IResult =>
        result.SwitchAsync(value => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)resultHandler(context, value),
                           error => resultErrorHandler1(error, context)
                                    .Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x)
                                    .OrElse(() => resultErrorHandler2(error, context)
                                                .Map(x => (Results<TIResult, TErrorIResult1, TErrorIResult2, TErrorIResult3, BadRequest<ProblemDetails>>)x))
