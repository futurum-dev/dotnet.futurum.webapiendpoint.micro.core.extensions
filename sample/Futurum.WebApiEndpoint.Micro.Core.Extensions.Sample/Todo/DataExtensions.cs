...
public static class DataExtensions
{
    ...
    public static async IAsyncEnumerable<T?> QueryAsync<T>(this SqliteConnection connection, string commandText, params (string Name, object? Value)[] parameters)
        where T : IDataReaderMapper<T>
    {
    ...
    private static async Task<SqliteDataReader> QueryAsync(this SqliteConnection connection, string commandText, params (string Name, object? Value)[] parameters)
    {
