...
public class WebApiResultsExtensionsToWebApiBadRequestErrorIResult3Tests
{
    ...
    public class NonGeneric
    {
        ...
        private static void ValidateBadRequest(Results<Ok, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
        ...
        private static void ValidateNotFound(Results<Ok, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
        ...
        private static void ValidateAccepted(Results<Ok, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
            results.Result.Should().BeOfType<Accepted>();
        }

        private static void ValidateCreated(Results<Ok, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
    ...
    public class Generic
    {
        ...
        private static void ValidateBadRequest(Results<Ok<string>, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
            results.Result.Should().BeOfType<BadRequest<ProblemDetails>>();
            results.Result.As<BadRequest<ProblemDetails>>().StatusCode.Should().Be((int)HttpStatusCode.BadRequest);
            results.Result.As<BadRequest<ProblemDetails>>().Value.Detail.Should().Be(ERROR_MESSAGE);
        ...
        private static void ValidateNotFound(Results<Ok<string>, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
            results.Result.Should().BeOfType<NotFound<ProblemDetails>>();
            results.Result.As<NotFound<ProblemDetails>>().StatusCode.Should().Be((int)HttpStatusCode.NotFound);
            results.Result.As<NotFound<ProblemDetails>>().Value.Detail.Should().Be($"Unable to find key : '{KEY}' in source : '{SOURCE_DESCRIPTION}'");
        ...
        private static void ValidateAccepted(Results<Ok<string>, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
            results.Result.Should().BeOfType<Accepted>();
        }

        private static void ValidateCreated(Results<Ok<string>, NotFound<ProblemDetails>, Accepted, Created, BadRequest<ProblemDetails>> results)
        {
            results.Result.Should().BeOfType<Created>();
        }
    }
