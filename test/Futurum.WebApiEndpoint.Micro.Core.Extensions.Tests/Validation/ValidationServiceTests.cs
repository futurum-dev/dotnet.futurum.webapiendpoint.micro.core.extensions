...
namespace Futurum.WebApiEndpoint.Micro.Core.Extensions.Tests.Validation;
...
public class ValidationServiceTests
{
    public class Sync
    {
        ...
        public class WithOneValidation
        {
            ...
            public class ValidatorSuccess : AbstractValidator<HasValidation>
            {
            }

            public class ValidatorFailure : AbstractValidator<HasValidation>
            {
